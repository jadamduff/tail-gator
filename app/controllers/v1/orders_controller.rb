class V1::OrdersController < ApplicationController
  ...
  def create
    ...
    initial_list_item = {list_item: initial_list_item, list_item_total: ActionController::Base.helpers.number_with_precision((@product.price * params[:product_quantity]), :precision => 2)}
